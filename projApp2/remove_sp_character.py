...
def detect_document(gcs_source_uri, gcs_destination_uri, filename):
...
def receive_file(subject, inutType, answer_file, schema_file):
    ...
    if subject=="English":
        ...
        fin = evaluate_answer(subject,fname,schema_path)
    elif subject=="Science":
        fname='/Users/Shivani T Eswara/finyear/visionapi/projApp2/app/static/answers/scianswers.txt'
        fin=evaluate_answer(subject,fname,schema_path)
    else:
        fname='/Users/Shivani T Eswara/finyear/visionapi/projApp2/app/static/answers/social1solution1.txt'
        fin=evaluate_answer(subject,fname,schema_path) 
        
    listex=[['any','one'],['three','two'],['strings']]
